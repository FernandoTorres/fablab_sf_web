 ...
 */
class Version20151230123544 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('INSERT INTO role(id,name,role) VALUES (1,"Rol Administrador","ROLE_ADMIN")');
        $this->addSql('INSERT INTO role(id,name,role) VALUES (2,"Rol Usuario","ROLE_USER")');
